/*
 *CSE331L Project: Temparature Controlled Fan 
 *Group: G12
 */
...
int minTemp = 25;    // Fan will start when the temperature will be 20°C
int maxTemp = 45;   // The Fan will reach its maximum speed (100%) when the temperature will be 40°C
int temp;
int fanSpeed;
int fanLCD;
